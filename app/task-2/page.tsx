export default function learnpage() {
    return (
        <section className="min-h-screen bg-gray-100 p-8 flex justify-center items-center">
            <div className="flex flex-col gap-6">
                <div className="flex gap-6">
                    <div className="bg-cyan-100 p-8 h-72 flex-1 rounded-4xl flex flex-col justify-between text-teal-900">
                    ...
                    <div className="bg-green-100 p-8 h-72 flex-1 rounded-4xl flex flex-col justify-between text-green-900">
