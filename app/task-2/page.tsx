    ...
    return (
        <section className="min-h-screen bg-gray-100 p-8 flex flex-col justify-center items-center gap-6">
            <div className="flex gap-6">
                <div className="bg-cyan-100 p-8 h-72 w-147.5 rounded-4xl flex flex-col justify-between text-teal-900">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="flex -space-x-3">
                            <div className="w-10 h-10 rounded-full bg-gray-400 border-2 border-cyan-100">
                            <div className="w-10 h-10 rounded-full bg-gray-500 border-2 border-cyan-100">
                            <div className="w-10 h-10 rounded-full bg-gray-600 border-2 border-cyan-100">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-green-100 p-8 h-72 w-147.5 rounded-4xl flex flex-col justify-between text-green-900">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="flex -space-x-3">
                            <div className="w-10 h-10 rounded-full bg-gray-400 border-2 border-green-100">
                            <div className="w-10 h-10 rounded-full bg-gray-500 border-2 border-green-100">
                            <div className="w-10 h-10 rounded-full bg-gray-600 border-2 border-green-100">
                        </div>
                    </div>
                </div>
            </div>
